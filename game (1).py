...
class Game(ShowBase):
   def __init__(self):
       ...
       model = self.loader.loadModel('sky_sphere')
       model.reparentTo(self.render)
       base_texture = loader.loadTexture('stars_1k_tex.jpg')
       ...
       model = self.loader.loadModel('Planets/planet_sphere')
       model.reparentTo(self.render)
       base_texture = loader.loadTexture('Planets/venus_1k_tex.jpg')
       model.setTexture(base_texture)
       #model.setColor((1, 0, 0, 1))
       model.setPos(10, 10, 10)
       model.setScale(1, 1, 1)
       model.setHpr(90, 0, 0)

       model = self.loader.loadModel('Planets/planet_sphere')
       model.reparentTo(self.render)
       base_texture = loader.loadTexture('Planets/mars_1k_tex.jpg')
       model.setTexture(base_texture)
       model.setColor((1, 0, 0, 1))
       model.setPos(20, 25, 15)
       model.setScale(1, 1, 1)
       model.setHpr(90, 0, 0)

       model = self.loader.loadModel('Planets/planet_sphere')
       model.reparentTo(self.render)
       base_texture = loader.loadTexture('Planets/moon_1k_tex.jpg')
       model.setTexture(base_texture)
       #model.setColor((1, 0, 0, 1))
       model.setPos(5, 30, 15)
       model.setScale(1, 1, 1)
       model.setHpr(90, 0, 0)
